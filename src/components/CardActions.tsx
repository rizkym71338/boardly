...
const CardActions = ({ cardData }: { cardData: Card }) => {
  ...
  return (
    <div className='mt-2 space-y-2'>
      ...
      <Button className='w-full bg-gray-200 text-gray-700 hover:bg-gray-200' size='sm' onClick={handleCopy}>
        Copy
      </Button>
      <Button className='w-full bg-gray-200 text-gray-700 hover:bg-gray-200' size='sm' onClick={handleDelete}>
        Delete
      </Button>
    </div>
  )
