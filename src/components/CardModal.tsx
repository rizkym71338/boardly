          ...
          <div className='col-span-3'>
            <div className='flex gap-3'>
              {cardData?.users?.map((user: User) => (
                <div
                  className="relative after:absolute after:right-[-5px] after:top-[-10px] after:flex after:h-4 after:w-4 after:cursor-pointer after:items-center after:justify-center after:rounded-full after:bg-purple-500 after:text-white after:content-['x']"
