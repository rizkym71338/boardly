...
export const cardCreate = async (data: { title: string; listId: string; boardId: string }) => {
...
// add members in card
export const getWithoutCardMembers = async (data: { boardId: string; cardId: string }) => {
