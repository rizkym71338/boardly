...
export const createOgranization = async (data: { title: string; image: string }) => {
...
export const getWithoutOrgMembers = async (data: { organizationId: string }) => {
  const session = getAuthSession()
...
export const updateOrgMember = async (data: { id: string; organizationId: string; orgIds: any; userIds: any }) => {
  const session = getAuthSession()
...
// remove org member
export const removeOrgMember = async (data: { userId: string; organizationId: string }) => {
  const session = getAuthSession()
  ...
  try {
    ...
    const updateOrgUserIds = organization.userIds.filter((id: string) => id != userId)
